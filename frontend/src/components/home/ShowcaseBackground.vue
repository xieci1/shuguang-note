<template>
  ...
  <div class="showcase-background" :class="{ 'is-ready': isReady }">
    <div class="showcase-grid" :style="{ transform: `rotate(-7deg) translateY(-${scrollOffset}px)` }">
...
.showcase-background {
  ...
  z-index: -1;
  background:
    radial-gradient(circle at 12% 16%, rgba(45, 212, 191, 0.16), transparent 28%),
    radial-gradient(circle at 86% 18%, rgba(244, 184, 96, 0.18), transparent 26%),
    linear-gradient(135deg, #071117 0%, #0d1c24 52%, #101820 100%);
  overflow: hidden;
  opacity: 0;
...
.showcase-overlay {
  ...
  bottom: 0;
  background:
    linear-gradient(90deg, rgba(7, 17, 23, 0.92) 0%, rgba(7, 17, 23, 0.72) 44%, rgba(7, 17, 23, 0.9) 100%),
    linear-gradient(180deg, rgba(7, 17, 23, 0.72), rgba(7, 17, 23, 0.96));
